...
const teachers = [
    {
        ...
        hoursPerWeek: 40,
        salary: 2000,
        salaryPerHour: function () { return this.salary / 4 / this.hoursPerWeek }
    },
    {
        name: "Daan",
        profession: "Teacher",
...
console.log("opdracht 3")
for (i = 0; i < 3; i++) {
    console.log(teachers[i].salaryPerHour())
}


//opdrachten DOM
console.log("opdrachten DOM")
//opdarcht 1
console.log("opdracht 1")
var gemiddelde = 0 ;
var course;
...
for (i = 1; i < 5; i++) {
course = document.getElementById("course"+i).lastElementChild.innerHTML;
gemiddelde = gemiddelde+ Number(course);
}
console.log(gemiddelde)

const tr = document.createElement("tr");
const td = document.createElement("td");
const gettable = document.getElementById("table1");

tr.appendChild(td).innerText =gemiddelde;
gettable.appendChild(tr);

//opdrach 2
console.log("opdracht 2")
var getcourse;
function backgroundColor(whatcourse,whatColor){
    getcourse = document.getElementsByClassName(whatcourse);
    getcourse[0].style.backgroundColor = whatColor; 
}

for(i=1;i<8;i++){
 backgroundColor("course"+i,"rgb(0,"+255/8*i+","+255/i+"");
 }
